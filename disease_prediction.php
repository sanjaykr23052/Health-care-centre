...
<body class="container display-4">
  ...
  <table class="table table-hover table-dark">
    ...
    <tr>
      <th class="text-center"><a href=Display_doctor_list_on_users_home_page/bone.php>Orthopedic</a></th>
    </tr>
    <tr>
      <th class="text-center"><a href=Display_doctor_list_on_users_home_page/dentist.php>Dentist</a></th>
    </tr>
    <tr>
      <th class="text-center"><a href=Display_doctor_list_on_users_home_page/cardiac_electrophysiologist.php>Cardiac electrophysiologist</a></th>
    </tr>
    <tr>
      <th class="text-center"><a href=Display_doctor_list_on_users_home_page/cardiologist.php>Cardiologist</a></th>
    </tr>
    <tr>
      <th class="text-center"><a href=Display_doctor_list_on_users_home_page/surgeon.php>Surgeon</a></th>
    </tr>
    <tr>
      <th class="text-center"><a href="Display_doctor_list_on_users_home_page/gynecologist.php">Gynecologist</a></th>
    </tr>
    <br><br>
    <h2>
      <div class="container ">
